...
class Notifikasi extends Controller
{
    ...
    {
        return $this->kirimPesanDosen($dosen_id, "BERHALANGAN HADIR");
    }

    public function dosenMasuk($dosen_id)
    {
        return $this->kirimPesanDosen($dosen_id, "AKAN HADIR MENGISI SESI KULIAH");
    }
    ...
    private function kirimPesanDosen($dosen_id, $status)
    {
        ...
        $message = "Informasi Perkuliahan, Untuk Dosen: " . $dosen['nama_dosen'] . ", Mata Kuliah: " . $dosen['nama_matkul'] . " " . $status . " hari ini.";
